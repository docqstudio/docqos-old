...
#define EHWPOISON       133     /* Memory page has hardware error. */
   /*These marcos are borrowed from /usr/include/asm-generic/errno.h and error-base.h .*/

inline void *makeErrorPointer(s64 errorcode) __attribute__ ((always_inline));
inline s64 getPointerError(void *pointer) __attribute__ ((always_inline));
inline int isErrorPointer(void *pointer) __attribute__ ((always_inline));

inline void *makeErrorPointer(s64 errorcode)
{
   return (void *)errorcode;
}

inline s64 getPointerError(void *pointer)
{
   return (s64)pointer;
}

inline int isErrorPointer(void *pointer)
{
